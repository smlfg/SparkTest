...
# Initialize logger
logger = setup_logger(__name__, agent_name="agent6_monitoring")
...
app = FastAPI(
    title="Agent 6: System Monitoring And Metrics Collection Agent",
...
async def startup_event():
    ...
    logger.info("Agent 6 (System Monitoring And Metrics Collection Agent) is starting up...")
...
async def shutdown_event():
    ...
    logger.info("Agent 6 (System Monitoring And Metrics Collection Agent) is shutting down...")


if __name__ == "__main__":
    import uvicorn

    port = config.get("playbook", {}).get("ports", [8006])[0]
