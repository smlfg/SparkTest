...
# Initialize logger
logger = setup_logger(__name__, agent_name="agent9_orchestration")
...
app = FastAPI(
    title="Agent 9: Workflow Orchestration Agent",
...
async def startup_event():
    ...
    logger.info("Agent 9 (Workflow Orchestration Agent) is starting up...")
...
async def shutdown_event():
    ...
    logger.info("Agent 9 (Workflow Orchestration Agent) is shutting down...")


if __name__ == "__main__":
    import uvicorn

    port = config.get("playbook", {}).get("ports", [8009])[0]
