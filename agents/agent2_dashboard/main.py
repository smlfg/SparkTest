...
# Initialize logger
logger = setup_logger(__name__, agent_name="agent2_dashboard")
...
app = FastAPI(
    title="Agent 2: Dashboard And Visualization Agent",
    description="Dashboard and visualization agent",
    version="1.0.0"
)
...
async def startup_event():
    ...
    logger.info("Agent 2 (Dashboard And Visualization Agent) is starting up...")
...
async def shutdown_event():
    ...
    logger.info("Agent 2 (Dashboard And Visualization Agent) is shutting down...")


if __name__ == "__main__":
    import uvicorn

    port = config.get("playbook", {}).get("ports", [8002])[0]
